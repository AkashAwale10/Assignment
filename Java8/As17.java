...
public class As17
{
	...
	public void setSalary(int salary) {
		...
		public static void main(String[] args)
		{
			...
			list.add(new As17("sagar", "pune", LocalDate.of(2022, 04, 05),LocalDate.of(1995,06,27),LocalDate.of(2025,04,05), "JAVA",22000));
...
//---------------------------------------------------------------------------------------------------------------------------------	
			...
			List<As17> bnames=list.stream().filter(e->e.dob.getMonth()==currentdate.getMonth()).collect(Collectors.toList());
			for (As17 a : bnames)
			{
				System.out.println("Birth day of "+a.name+" and Birth Date is "+a.dob);
			}
			List<As17> bnames1=list.stream().filter(e->e.doj.getMonth()==currentdate.getMonth()).collect(Collectors.toList());
			for (As17 a : bnames1)
			{
